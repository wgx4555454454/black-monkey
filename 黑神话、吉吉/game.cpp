...
void Game::game() {
	...
	string strTemporary25 = "这是一个简单的RPG游戏";
...
void Game::setEnemy() {
	...
	Enemy e4(200, 16, "白衣秀士", strWords4);
